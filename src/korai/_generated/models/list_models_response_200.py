...
T = TypeVar("T", bound="ListModelsResponse200")


@_attrs_define
class ListModelsResponse200:
    """
    Attributes:
        object_ (Literal['list'] | Unset):
        data (list[Model] | Unset):
    """

    object_: Literal["list"] | Unset = UNSET
    data: list[Model] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_models_response_200 = cls(
            object_=object_,
            data=data,
        )

        list_models_response_200.additional_properties = d
        return list_models_response_200
