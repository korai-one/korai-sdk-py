...
T = TypeVar("T", bound="GetWorkerScheduleResponse200")


@_attrs_define
class GetWorkerScheduleResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_worker_schedule_response_200 = cls(
            schedule=schedule,
        )

        get_worker_schedule_response_200.additional_properties = d
        return get_worker_schedule_response_200
