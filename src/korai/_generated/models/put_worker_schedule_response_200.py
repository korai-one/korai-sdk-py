...
T = TypeVar("T", bound="PutWorkerScheduleResponse200")


@_attrs_define
class PutWorkerScheduleResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_worker_schedule_response_200 = cls(
            schedule=schedule,
        )

        put_worker_schedule_response_200.additional_properties = d
        return put_worker_schedule_response_200
